...
public class DamagePopManager : Singleton<DamagePopManager>
{
    ...
    public void CreateDamagePop(bool isCrit, float amt, Vector2 position, Transform parent)
    {
    ...
    {
        GameObject clone = PoolManager.instance.Release(textprefab, trans, Quaternion.identity,parent);
        switch (type)
        {
